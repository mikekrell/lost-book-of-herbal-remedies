  ...
  return (
    <div style={{width: '980px'}} className="flex flex-col justify-center m-auto">
      ...
      <div className="flex flex-col m-10 mt-20" >
        ...
        <div>
        <div style={{backgroundColor: "beige"}} className="p-10 flex">
        ...
        <div className="p-10 flex flex-col">
          ...
          <div className="flex flex-col">
            <div style={{ backgroundColor: "beige" }} className="p-10">
            ...
            <div className="mt-10 bg-green-500 p-3 items-center flex flex-col mb-8">
              ...
              <p><a href="https://vimeo.com/471422053">The Forgotten Power of Plants with Nicole Apelian</a> from <a alt="Power of Plants" href="https://vimeo.com/user124582185">Joao Murillo</a> on <a alt="Vimeo Link" href="https://vimeo.com">Vimeo</a>.</p>
