    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div className={styles.header}>
          ...
          <div className={styles.header_cta}>
            ...
            <Link className={styles.cta} to="watchvideocta" smooth={true}><div style={{ fontWeight: 'bold', fontSize: '.75em', width: '280px', backgroundColor: "#804400", textAlign: 'center'}}>CLICK HERE TO GET IT NOW! </div></Link>
      ...
      <div className={styles.section1}>
        ...
        <div name="watchvideocta" className={styles.section4}>
            <Link className={styles.cta} to="video" smooth={true}><div className={styles.cta_text} style={{ backgroundColor: "#804400" }}>CLICK HERE TO WATCH THE VIDEO</div>
            </Link>
        </div>
